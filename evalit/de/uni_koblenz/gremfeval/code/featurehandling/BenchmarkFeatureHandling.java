...
public class BenchmarkFeatureHandling {
		...
		try {
			...
			PrintStream logStream = new PrintStream(new FileOutputStream(
					System.getProperty("user.dir") + File.separator + "evalit"
							+ File.separator + ".featurehandling_log.txt"));
			...
			PrintStream benchStream = new PrintStream(new FileOutputStream(file
					+ File.separator + "featurehandling_bechnmark.txt"));
			...
			benchStream.println(new Benchmark(
					new EMFFeatureHandlingEval(false), params));
			benchStream.flush();
			benchStream.print("EMF view: ");
			benchStream.println(new Benchmark(new EMFFeatureHandlingEval(true),
					params));
			benchStream.flush();
			benchStream.print("JGraLab: ");
			benchStream.println(new Benchmark(new JGraLabFeatureHandlingEval(
					false), params));
			benchStream.flush();
