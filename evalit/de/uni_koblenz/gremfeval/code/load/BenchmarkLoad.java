	...
	public static void main(String[] args) {
		try {
			...
			PrintStream benchStream = new PrintStream(new FileOutputStream(file
					+ File.separator + "load_bechnmark.txt"));

			Benchmark.Params params = new Benchmark.Params();
			params.setNumberMeasurements(50);
			benchStream.print("EMF: ");
			benchStream.println(new Benchmark(new EMFLoadEval(false), params));
			benchStream.flush();
			benchStream.print("EMF views: ");
			benchStream.println(new Benchmark(new EMFLoadEval(true), params));
			benchStream.flush();
			benchStream.print("JGraLab: ");
			benchStream.println(new Benchmark(new JGraLabLoadEval(false),
					params));
			benchStream.flush();
			benchStream.print("JGraLab view: ");
			benchStream
					.println(new Benchmark(new JGraLabLoadEval(true), params));
			benchStream.close();
