...
import de.uni_koblenz.gremf.resource.GrEMFInstanceResourceImpl;
import de.uni_koblenz.gremf.resource.GrEMFResourceFactoryImpl;

public class FactoryTest {

	@Test
	public void grEMFInstanceTest() {
		...
		Resource instance = rs.getResource(
				URI.createURI(System.getProperty("user.dir") + File.separator
						+ "models" + File.separator + "model1.a"), true);
		assertTrue(instance instanceof GrEMFInstanceResourceImpl);
